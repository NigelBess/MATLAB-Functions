function errorLine = errorbarxy(x,y,lx,ly,ux,uy,errorcol)
...
if ~isempty(ux)
    %x errorbars
        errorLine = line([x(t)-lx(t) x(t)+ux(t)],[y(t) y(t)],'color',errorcol,'Linewidth',0.125);
    line([x(t)-lx(t) x(t)-lx(t)],[y(t)-yw y(t)+yw],'color',errorcol,'Linewidth',0.125)    
        line([x(t)+ux(t) x(t)+ux(t)],[y(t)-yw y(t)+yw],'color',errorcol,'Linewidth',0.125)    
    end
    
    if ~isempty(uy)
    %y errorbars
    errorLine = line([x(t) x(t)],[y(t)-ly(t) y(t)+uy(t)],'color',errorcol,'Linewidth',0.125);
    line([x(t)-xw x(t)+xw],[y(t)-ly(t) y(t)-ly(t)],'color',errorcol,'Linewidth',0.125)    
        line([x(t)-xw x(t)+xw],[y(t)+uy(t) y(t)+uy(t)],'color',errorcol,'Linewidth',0.125) 
    end    
end
